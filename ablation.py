...
if dataset == "voc":
    ...
    m =50
if dataset == "coco":
    all_targets = np.load('coco_moco_results_m=50/all_targets.npy')
    all_outputs = np.load('coco_moco_results_m=50/all_outputs.npy')
if dataset == "nus":
    all_targets = np.load('nus_moco_results_m=50/all_targets.npy')
    all_outputs = np.load('nus_moco_results_m=50/all_outputs.npy')
if dataset == "voc":
    all_targets = np.load('voc_moco_results_linear_m=20/all_targets.npy')
    all_outputs = np.load('voc_moco_results_linear_m=20/all_outputs.npy')
targets = all_targets[0]
...
if dataset == "voc":
    ...
    m =100
if dataset == "coco":
    all_targets = np.load('coco_moco_results_m=100/all_targets.npy')
    all_outputs = np.load('coco_moco_results_m=100/all_outputs.npy')
if dataset == "nus":
    all_targets = np.load('nus_moco_results_m=100/all_targets.npy')
    all_outputs = np.load('nus_moco_results_m=100/all_outputs.npy')
if dataset == "voc":
    all_targets = np.load('voc_moco_results_m=50/all_targets.npy')
    all_outputs = np.load('voc_moco_results_m=50/all_outputs.npy')
targets = all_targets[0]
...
plt.plot( Ts,r_1, label = r'$m$ = 20',color ="red")

#plt.plot( Ts,bagging_recalls, label = 'Bagging Recall',linestyle = '--',color ="b")
plt.plot( Ts,r_2, label = r'$m$ = 50',linestyle = '--',color ="orange")
#plt.plot( Ts,dpa_recalls, label = 'Ours(DPA) Recall',linestyle = '-.',color ="b")
plt.plot( Ts,r_3, label = r'$m$ = 100',linestyle = '-.',color ="b")
...
plt.tight_layout()
plt.savefig(dataset+'_m_bagging_recall.pdf', dpi=1000,bbox_inches='tight')
#plt.title('k=10')
plt.figure(figsize = (7,4))
#plt.plot(Ts,recalls, label = 'Ours(Bagging) Recall',color ="b")
plt.plot( Ts,p_1, label =r'$m$ = 20',color ="red")

#plt.plot( Ts,bagging_recalls, label = 'Bagging Recall',linestyle = '--',color ="b")
plt.plot( Ts,p_2, label = r'$m$ = 50',linestyle = '--',color ="orange")
#plt.plot( Ts,dpa_recalls, label = 'Ours(DPA) Recall',linestyle = '-.',color ="b")
plt.plot( Ts,p_3, label = r'$m$ = 100',linestyle = '-.',color ="b")
#plt.plot( Ts,dpa_ind_recalls, label = 'DPA Recall',linestyle = 'dotted',color ="b")
...
plt.yticks(fontsize=16)
plt.tight_layout()
plt.savefig(dataset+'_m_bagging_precision.pdf', dpi=1000,bbox_inches='tight')
plt.rcParams['figure.dpi'] = 1000
plt.show()
plt.figure(figsize = (7,4))
#plt.plot(Ts,recalls, label = 'Ours(Bagging) Recall',color ="b")
plt.plot( Ts,f_1, label = r'$m$ = 20',color ="red")

#plt.plot( Ts,bagging_recalls, label = 'Bagging Recall',linestyle = '--',color ="b")
plt.plot( Ts,f_2, label = r'$m$ = 50',linestyle = '--',color ="orange")
#plt.plot( Ts,dpa_recalls, kabel = 'Ours(DPA) Recall',linestyle = '-.',color ="b")
plt.plot( Ts,f_3, label = r'$m$ = 100',linestyle = '-.',color ="b")
...
plt.yticks(fontsize=16)
plt.tight_layout()
plt.savefig(str(dataset)+'_m_bagging_f1.pdf', dpi=1000,bbox_inches='tight')
plt.rcParams['figure.dpi'] = 1000
plt.show()
